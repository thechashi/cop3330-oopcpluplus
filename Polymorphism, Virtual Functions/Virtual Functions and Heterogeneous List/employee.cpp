...
Temporary::Temporary(const char* n, const char* a, const char* ssn, 
			float hw, float hr):  Employee(n, a, ssn)
...
Permanent::Permanent(const char* n, const char* a, const char* ssn)
					: Employee(n, a, ssn)
...
Hourly::Hourly(const char* n, const char* a, const char* ssn, 
			float hw, float hr): Permanent(n, a, ssn)
...
Salaried::Salaried(const char* n, const char* a, const char* ssn, float wp)
					: Permanent(n, a, ssn)
